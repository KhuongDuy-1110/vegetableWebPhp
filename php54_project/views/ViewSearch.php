...
<div class="col-lg-12 col-md-12">
    <div class="product__discount">
        <div class="section-title product__discount__title">
            <h2 style="font-size: 20px;">Search - Price from <?php echo number_format($minamount); ?>$ to <?php echo number_format($maxamount); ?>$</h2>
        </div>
        <div class="row">
        ...
        <div class="product__pagination">
            <?php for ($i = 1; $i <= $numPage; $i++): ?>
                <a href="index.php?controller=search&fromPrice=<?php echo $minamount ?>&toPrice=<?php echo $maxamount ?>&p=<?php echo $i;?>"><?php echo $i; ?></a>
            <?php endfor; ?>
