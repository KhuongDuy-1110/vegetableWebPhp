...
<head>
    ...
    <title>Ogani</title>
    <link rel="shortcut icon" type="image/jpg" href="assets/frontend/img/blog/sidebar/sr-3.jpg"/>
...
<script type="text/javascript">
    ...
    (function(){
        ...
        s1.async=true;
        s1.src='https://embed.tawk.to/6061ba2ef7ce18270934fa7a/1f1urui23';
        s1.charset='UTF-8';
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-9">
                <div class="hero__search">
                    <div class="hero__search__form">
                        <form>
                            ...
                            <div class="search">
                                <input type="text" style="position: relative;" value="" id="key" placeholder="What do yo u need?">
                    ...
                    <div class="smart-search">
                        <ul>
                            <li><img src="http://localhost/php54/vegetable_proj/php54_project/assets/upload/products/1616256941_feature-7.jpg"><a href="#">Vegetable1</a></li>
                            <li><img src="http://localhost/php54/vegetable_proj/php54_project/assets/upload/products/1616256941_feature-7.jpg"><a href="#">Vegetable2</a></li>
                            <li><img src="http://localhost/php54/vegetable_proj/php54_project/assets/upload/products/1616256941_feature-7.jpg"><a href="#">Vegetable3</a></li>
                        </ul>
                    </div>
                    <style>
                        .smart-search{
                ...
                <div class="hero__item set-bg" data-setbg="assets/frontend/img/hero/banner.jpg">
                    <div class="hero__text">
                        <span>FRUIT FRESH</span>
                        <h2>Vegetable <br />100% Organic</h2>
                        <p>Free Pickup and Delivery Available</p>
                        <a href="index.php?controller=products&action=category&id=9" class="primary-btn">SHOP NOW</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-12">
                <div class="footer__copyright">
                    <div class="footer__copyright__text"><p>
                            Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Made with <i class="fa fa-heart" aria-hidden="true"></i> by <a href="#" target="_blank">KhuongDuy</a></p></div>
